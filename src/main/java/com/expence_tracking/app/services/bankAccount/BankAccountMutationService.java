...
import com.expence_tracking.app.dto.binding.bank_account.BankAccountUpdate;
...
public class BankAccountMutationService implements GraphQLMutationResolver
{
    ...
    public BankAccount updateBankAccount(BankAccountUpdate form) throws GenericSQLException
    {
